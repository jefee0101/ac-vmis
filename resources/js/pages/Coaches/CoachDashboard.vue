        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p class="text-sm text-slate-600">
              {{ props.team?.sport ? `Sport: ${props.team.sport}` : 'Your control surface for attendance, wellness checks, and team schedules.' }}
            </p>
          </div>
          ...
          <div class="rounded-2xl border border-[#034485]/25 bg-white p-4">
            ...
            <p class="text-xs text-slate-500">
              {{ props.nextSchedule ? `${formatPHT(props.nextSchedule.start)} • ${props.nextSchedule.venue || '-'}`
                : 'Create a new schedule to keep your team on track.' }}
            </p>
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">Create, edit, and organize team events.</p>
              </div>
            </div>
          </button>
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">Attendance and wellness in one workspace.</p>
                <p v-if="safeMetrics.attendance_needs_review > 0 || safeMetrics.wellness_pending > 0" class="mt-1 text-[11px] font-semibold text-rose-600">
                  {{ safeMetrics.attendance_needs_review }} attendance gaps • {{ safeMetrics.wellness_pending }} wellness pending
                </p>
              </div>
            </div>
          </button>
          ...
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-slate-500">Monitor submissions and GPA status.</p>
                <p v-if="safeMetrics.academic_missing > 0" class="mt-1 text-[11px] font-semibold text-emerald-700">
                  {{ safeMetrics.academic_missing }} missing submissions
                </p>
              </div>
            </div>
          </button>
