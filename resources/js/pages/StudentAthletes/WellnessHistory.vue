...
const filteredLogs = computed(() => {
    ...
    return items.filter((row) => {
        ...
        if (!q) return true
        return (row.team_name || '').toLowerCase().includes(q)
                ...
                >
                    <div class="flex items-center justify-between gap-2">
                        ...
                        <span class="text-xs rounded-full px-2 py-0.5"
                            :class="row.injury_observed ? 'bg-rose-50 text-rose-700 border border-rose-200' : 'bg-emerald-50 text-emerald-700 border border-emerald-200'"
                        >
                        ...
                        <tbody>
                            <tr v-for="row in filteredLogs" :key="row.id" class="border-t border-[#034485]/20 text-slate-700">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    <div :class="row.injury_observed ? 'text-rose-600 text-xs' : 'text-emerald-600 text-xs'">
