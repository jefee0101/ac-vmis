                            ...
                            <div class="space-y-2 text-xs">
                                <div>
                                    <div class="mb-1 flex justify-between">
                                        <span class="text-slate-600">Fit</span
                                        ><span class="font-semibold text-slate-900">{{ dashboard.trends.health_distribution.fit }}</span>
                                    </div>
                                    <div class="h-2 rounded-full bg-slate-100">
                                        <div
                                            ...
                                            :style="{
                                                width: `${healthPercent(
                                                    dashboard.trends.health_distribution.fit,
                                                    Object.values(dashboard.trends.health_distribution).reduce((a, b) => a + b, 0),
                                                )}%`,
                                            }"
                                        />
                                    </div>
                                ...
                                <div>
                                    <div class="mb-1 flex justify-between">
                                        <span class="text-slate-600">Fit w/ Restriction</span
                                        ><span class="font-semibold text-slate-900">{{
                                            dashboard.trends.health_distribution.fit_with_restrictions
                                        }}</span>
                                    </div>
                                    <div class="h-2 rounded-full bg-slate-100">
                                        <div
                                ...
                                <div>
                                    <div class="mb-1 flex justify-between">
                                        <span class="text-slate-600">Not Fit</span
                                        ><span class="font-semibold text-slate-900">{{ dashboard.trends.health_distribution.not_fit }}</span>
                                    </div>
                                    <div class="h-2 rounded-full bg-slate-100">
                                        <div
                                            ...
                                            :style="{
                                                width: `${healthPercent(
                                                    dashboard.trends.health_distribution.not_fit,
                                                    Object.values(dashboard.trends.health_distribution).reduce((a, b) => a + b, 0),
                                                )}%`,
                                            }"
                                        />
                                ...
                                <div>
                                    <div class="mb-1 flex justify-between">
                                        ...
                                        ><span class="font-semibold text-slate-900">{{ dashboard.trends.health_distribution.expired }}</span>
                                    </div>
                                    <div class="h-2 rounded-full bg-slate-100">
                                        <div
                                            ...
                                            :style="{
                                                width: `${healthPercent(
                                                    dashboard.trends.health_distribution.expired,
                                                    Object.values(dashboard.trends.health_distribution).reduce((a, b) => a + b, 0),
                                                )}%`,
                                            }"
                                        />
